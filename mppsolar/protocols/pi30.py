...
QUERY_COMMANDS = {
    ...
    "QPIGS": {
        ...
        "response": [
            ...
            [1, "AC Input Frequency", "float", "Hz", {"icon": "mdi:sine-wave"}],
            [2, "AC Output Voltage", "float", "V", {"icon": "mdi:transmission-tower-export"}],
            [3, "AC Output Frequency", "float", "Hz", {"icon": "mdi:sine-wave"}],
            [4, "AC Output Apparent Power", "int", "VA", {"icon": "mdi:flash-outline"}],
            [5, "AC Output Active Power", "int", "W", {"icon": "mdi:lightning-bolt"}],
            [6, "AC Output Load", "int", "%", {"icon": "mdi:gauge"}],
            [7, "BUS Voltage", "int", "V", {"icon": "mdi:current-dc"}],
            [8, "Battery Voltage", "float", "V", {"icon": "mdi:battery"}],
            [9, "Battery Charging Current", "int", "A", {"icon": "mdi:current-dc"}],
            [10, "Battery Capacity", "int", "%", {"icon": "mdi:battery-high"}],
            [11, "Inverter Heat Sink Temperature", "int", "°C", {"icon": "mdi:thermometer"}],
            [12, "PV Input Current for Battery", "float", "A", {"icon": "mdi:solar-power"}],
            [13, "PV Input Voltage", "float", "V", {"icon": "mdi:solar-panel"}],
            [14, "Battery Voltage from SCC", "float", "V", {"icon": "mdi:battery-charging"}],
            [15, "Battery Discharge Current", "int", "A", {"icon": "mdi:battery-minus"}],
            [
                16,
                "Device Status",
                "flags",
